...
public class Login implements ActionListener {
	...
	public Login() {
		...
		// frame.setContentPane(new JLabel(new ImageIcon("D:\\Summer Training
		// Project\\src\\com\\css\\controller\\WELCOME.jpeg")));
		...
		// ImageIcon studentbutton = new ImageIcon("D:\\Summer Training
		// Project\\img\\student.png");
		...
		if (e.getSource() == back) {
			...
			if (trainer.isSelected()) {
				...
				if (bool) {
					...
					StudentVO studentVO = studentService.searchStudentService(s1);
